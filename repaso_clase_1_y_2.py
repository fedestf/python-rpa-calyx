...
for palabra in range(0, len(palabras)):
    dic_palabras[palabras[palabra]] = (
        'La palabra tiene {} letras'.format(len(palabras[palabra])))
...
for key in diccionario["acciones"]:  # Accedo a las keys del diccionario acciones
    lista_resultado.append(
        (diccionario["acciones"][key](diccionario["datos"][key])))  # con las keys del diccionario acciones paso el valor de los datos que tienen la misma key
